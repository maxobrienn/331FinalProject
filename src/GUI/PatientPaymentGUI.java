/**
 * This class represents a graphical user interface (GUI) for making payments by patients.
 * It allows patients to enter payment details such as amount and prescription ID.
 * The GUI also provides a button to make payments and return to the patient menu.
 */
package GUI;
...
public class PatientPaymentGUI extends JFrame {
    ...
    /**
     * Constructs a PatientPaymentGUI object.
     * @param patient The patient for whom the payment is being made.
     */
    ...
    /**
     * Closes the payment window and returns to the patient menu.
     */
    ...
    /**
     * Makes a payment using the entered amount and prescription ID.
     */
    ...
    /**
     * Checks if a prescription ID is valid by querying the database.
    ...
    /**
     * The main method to run the PatientPaymentGUI.
