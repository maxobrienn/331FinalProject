...
public class Pharmacy {
 ...
 public boolean pharmacyLogin(String pharmacyId, String password) {
     Connection con = openDBConnection();
     try {
         PreparedStatement statement = con.prepareStatement("SELECT COUNT(*) FROM HealthCareManagement_PHARMACY WHERE PHARMACY_ID = ? AND PASSWORD = ?");
